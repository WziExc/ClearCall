...
class _CallTabState extends ConsumerState<CallTab> {
  ...
  Widget _buildRecordList(
      BuildContext context, WidgetRef ref, List<CallRecord> records) {
    return Column(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              ...
                              style:
                                  styleTiny.copyWith(color: colorNeutral),
                            ),
                          ],
                        ),
                      ),
  ...
  void _showRecordOptions(
      BuildContext context, WidgetRef ref, CallRecord record) {
    showModalBottomSheet(
      context: context,
      backgroundColor: Colors.transparent,
  ...
  Future<void> _redialFriend(
      BuildContext context, WidgetRef ref, CallRecord record) async {
...
class _SwipeToDeleteRecord extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Dismissible(
      key: ValueKey(record.id ?? record.startTime.millisecondsSinceEpoch),
      ...
      confirmDismiss: (direction) async {
        return await showDialog<bool>(
              ...
              builder: (ctx) => AlertDialog(
                ...
                content: Text('确定删除与"${record.targetName}"的通话记录吗？'),
                actions: [
                  TextButton(
                    onPressed: () => Navigator.of(ctx).pop(false),
                    child: const Text('取消'),
      ...
      background: Container(
        ...
        decoration: BoxDecoration(
          color: colorDanger.withAlpha(230),
          borderRadius: BorderRadius.circular(radiusCard),
        ),
        child: const Icon(Icons.delete_rounded, color: colorWhite, size: 24.0),
      ),
